...
read_giovanni_nc_map <- function(giovanni_nc_map_file){
  ...
  return(as.data.table(giovanni_map_data))
}
...
anomaly <- read_giovanni_nc_map("./Data/g4.timeAvgMap.MODISA_L3m_SST_2014_sst4.20150101-20151231.180W_23S_180E_23N.nc")
anomaly <- rename(anomaly,year_temperature=temperature)
...
ggsave(plot=p, filename="./Plots/file.jpg")
